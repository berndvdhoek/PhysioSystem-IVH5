...
public class Settings {
	...
	public static final String propXmlFileLocation = "xml.filelocation";
	public static final String propXmlSchemaLocation = "xml.schemalocation";
	public static final String propXmlEmployeesFile = "xml.employeefile";
	public static final String propXmlEmployeesXSD = "xml.employeexsd";
	public static final String propXmlAccountsFile = "xml.accountsfile";
	public static final String propXmlAccountsXSD = "xml.accountsxsd";
	public static final String propXmlCompanyInfoXSD = "xml.companyinfoxsd";
	public static final String propXmlCompanyInfoFile = "xml.companyinfofile";
